...
class traj_planner:
	...
	def __init__(self,Type, arg1, arg2, arg3, arg4):
		if Type == 1:
			...
			pt=arg3
			ts=arg4
			# Validate the percentage of acceleration
			if pt<0:
				pt=-pt
				print ("Warning: The percentage should not be a lower amount to zero, it will be positive")
			else:
				if pt>1:
					pt=1
					print ("Warning: The percentage is higher than 50%, will be assumed at 50%")
