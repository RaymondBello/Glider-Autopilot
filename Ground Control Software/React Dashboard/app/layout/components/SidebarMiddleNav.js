...
export const SidebarMiddleNav = () => (
    <SidebarMenu>
        <SidebarMenu.Item title="Dashboard" icon={<i className="fa fa-fw fa-dashboard"></i>} to='/dashboards/reports' exact />
        <SidebarMenu.Item title="System Monitor" to='/dashboards/monitor' exact />
        <SidebarMenu.Item title="Graphs" to='/graphs/re-charts' />
        <SidebarMenu.Item title="Sensors" to='/dashboards/system' exact />
        <SidebarMenu.Item title="Tasks" to='/dashboards/projects' exact />
