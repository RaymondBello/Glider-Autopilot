...
unsigned long channel_1_fs = CHAN1_FS; //thro
unsigned long channel_2_fs = CHAN2_FS; //ail
unsigned long channel_3_fs = CHAN3_FS; //elev
unsigned long channel_4_fs = CHAN4_FS; //rudd
unsigned long channel_5_fs = CHAN5_FS; //gear, greater than 1500 = throttle cut
unsigned long channel_6_fs = CHAN6_FS; //aux1
...
const int ch1Pin = CH1_PIN; //throttle
const int ch2Pin = CH2_PIN; //ail
const int ch3Pin = CH3_PIN; //ele
const int ch4Pin = CH4_PIN; //rudd
const int ch5Pin = CH5_PIN; //gear (throttle cut)
const int ch6Pin = CH6_PIN; //aux1 (free aux channel)
...
/******************************************* Radio Communication *********************************************/
/************************************************************************************************************/
unsigned long rising_edge_start_1, rising_edge_start_2, rising_edge_start_3, rising_edge_start_4, rising_edge_start_5, rising_edge_start_6; // rising edge of pwm
unsigned long channel_1_raw, channel_2_raw, channel_3_raw, channel_4_raw, channel_5_raw, channel_6_raw;                                     //raw pwm value
int ppm_counter = 0;
...
void setup()
{
    ...
    Serial.println("Calibrate Attitude");
    //Warm up the loop
